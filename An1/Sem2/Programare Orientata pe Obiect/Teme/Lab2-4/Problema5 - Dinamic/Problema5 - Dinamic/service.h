...
/*
* Filtreaza lista de tranzactii dupa un artist dat
*
...
/*
* Functie de comparare dupa elementele date dupa o zi data
* 
*/
...
/*
* Returneaza o lista sortata de tranzactii
* Criteriu de sortare: ziua (crescator)
*
* @param v: (adresa pentru) lista data (MyList* v)
* @param CMP: este -1 daca nu este o comparatie , 0 sau 1 pentru compararea pe care o atribuim
* @return: o lista sortata de melodii  (MyList)
*/

typedef int(*FunctieComparare)(Tranzactie* o1, Tranzactie* o2);
