...
public class Main extends Application {
    ...
    MesajDbRepositoryGUI mesajDbRepositoryGUI = new MesajDbRepositoryGUI("jdbc:postgresql://localhost:5432/academicGUI","postgres","1234");
    ...
    ServiceMesajGUI serviceMesajGUI = new ServiceMesajGUI(mesajDbRepositoryGUI);
...
//        Mesaj test = new Mesaj("Leo","Maria","Buna");
//        mesajDbRepositoryGUI.save(test);

        for(Mesaj msj: mesajDbRepositoryGUI.getAll()){
            System.out.println(msj.getNume() + " " + msj.getDestinatar() + " " + msj.getMesaj());
        }

//        for(Mesaj msj: mesajDbRepositoryGUI.findAll("Maria","Leo")){
//            System.out.println(msj.getNume() + " " + msj.getDestinatar() + " " + msj.getMesaj());
//        }
...
//        Scene scene = new Scene(rootLayout, 420, 240);
        ...
        login_controller.setService(serv,serviceFriendshipGUI,serviceMesajGUI);

        serviceFriendshipGUI.getAll().forEach(System.out::println);
//        serviceMesajGUI.printUs("Leo","Maria");

//        mesajDbRepositoryGUI.findAll("Leo","Maria");
