...
//        Repository<Long, User> repo = new UserFile("", new UserValidator());
        Repository<Long,User> repo = new UserDbRepository("jdbc:postgresql://localhost:5432/academic","postgres","1234",new UserValidator());

//        Repository<Tuple<Long,Long>, Friendship> repofriends = new FriendshipFile("data/prieteni.in", new FriendshipValidator());
