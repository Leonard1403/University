    ...
    public void show() {
        ...
        while (true) {
            ...
            System.out.println("""
                    ...
                    8-Afisare users
                    9-Afisare prietenii
                    10-Afisare user prietenii
                    11-Afisare dupa string
                    x-Exit
                    Your input:""");
...
//            Set<User> users= servUser.getFriends(nr);
        }
        catch (NumberFormatException e) {
            System.out.println("Id must be an integer number");
        }
...
//        System.out.println("abracadabra"=="abracadabra");
        try{
            User us= servUser.findUsername(String.valueOf(username.trim()));
